        ...
        <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
            <div class="col-lg-4">
                <a href="" class="text-decoration-none">
                    <span class="h1 text-uppercase text-primary bg-dark px-2">Time</span>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="./ProductDetail?id=1" class="nav-item nav-link">Chi tiết sản phẩm</a>
                            <a href="ContactServlet" class="nav-item nav-link">Liên hệ</a>
                            <a href="" class="nav-item nav-link">Tin tức</a>
                            <!-- <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Tin tức <i class="fa fa-angle-down mt-1"></i></a>
                                
                            </div> -->
                            <a href="ContactServlet" class="nav-item nav-link">Về chúng tôi</a>
                        </div>
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                        <a href="LogoutServlet" class="btn px-0">
                                <i class=" text-primary"></i>
                                <span class="badge text-secondary border border-secondary rounded-circle" style="padding-bottom: 2px;">Đăng xuất</span>
                            </a>
                            <a href="LoginServlet" class="btn px-0">
