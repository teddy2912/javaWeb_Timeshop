                ...
                <div class="container-fluid">
                    ...
                    <form action="EditOrderServlet" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input name="code" disabled type="text" class="form-control" id="cat" value="${order.code}" aria-describedby="" placeholder="Enter code">                            
                        </div>
                        <div class="form-group">
                            <label for="exampleInputStatus1">Description:</label>
                            <input name="description" type="text" class="form-control" id="cat" value="${order.description}" aria-describedby="" placeholder="Enter description">                            
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="exampleInputStatus1">Users Id:</label>
                            <input name="status" value="${order.usersId}" type="text" class="form-control" placeholder="${order.usersId}">
