...
<link href="./Public/admin/vendor/fontawesome-free/css/all.min.css"
...
<body id="page-top">
								...
								<table class="table table-bordered" id="datatablesSimple"
									...
									<tbody>
										...
										<c:forEach items="${orderList}" var="order">
											<tr>
												<td>${index}</td>
												<td><a href="ShowOrderServlet?orderId=${order.id}">
														${order.code} </a></td>
												<td>${order.description}</td>
												<td>${order.status}</td>
												<td>${order.usersId}</td>
												<td><a href="EditOrderServlet?id=${order.id}">Edit</a>
												</td>
												<td><a href="DeleteOrderServlet?id=${order.id}">Delete</a>
												</td>
											</tr>
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<a class="btn btn-primary"
						href="<?php echo url_pattern('authController', 'logout'); ?>">Logout</a>
				</div>
			</div>
		</div>
	</div>
	...
	<script
		src="./public/admin/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
