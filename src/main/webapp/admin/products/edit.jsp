                ...
                <div class="container-fluid">
                    ...
                    <form method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input name="name" value="${product.name}" type="text" class="form-control" id="cat" aria-describedby="" placeholder="Enter name">
                          
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Product price:</label>
                            <input name="price" value="${product.price}" type="text" class="form-control" id="cat" aria-describedby="" placeholder="Enter price">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Product quantity:</label>
                            <input name="quantity" value="${product.quantity}" type="text" class="form-control" id="cat" aria-describedby="" placeholder="Enter quantity">
                           
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Product image:</label>
                            <input name="image" value="${product.image}" type="text" class="form-control" id="cat" aria-describedby="" placeholder="Enter images">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Category ID:</label>
                            <input name="category" value="${product.categoryId}" type="text" class="form-control" id="cat" aria-describedby="" placeholder="Enter images">
                        </div>
